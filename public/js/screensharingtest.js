						...
						janus.attach({
							...
							webrtcState: function (on) {
								...
								if (on) {
									...
									bootbox.alert(
										"Your screen sharing session just stopped.",
										function () {
											janus.destroy();
							...
							onlocalstream: function (stream) {
								...
								if ($("#screenvideo").length === 0) {
									$("#screencapture").append(
										'<video class="rounded centered" id="screenvideo" width="100%" height="100%" autoplay playsinline muted="muted"/>'
									);
								}
	...
	janus.attach({
		...
		onremotestream: function (stream) {
			if ($("#screenvideo").length === 0) {
				...
				$("#screencapture").append(
					'<video class="rounded centered hide" id="screenvideo" width="100%" height="100%" autoplay playsinline/>'
				);
