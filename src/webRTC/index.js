            ...
            onmessage: function (msg, jsep) {
                ...
                if (result) {
                    if (result["list"]) {
                        ...
                        if (event === "registered") {
                            dispatch({
                                type: Constraint.EVENT_REGISTERED,
                                value: {
                                    registered: true,
                            ...
                            dispatch({
                                type: Constraint.EVENT_INCOMINGCALL,
                                value: {
                                    incomingcall: true,
                                    username: result["username"],
                                    jsep: jsep,
                            ...
                            dispatch({
                                type: Constraint.EVENT_ACCEPTED,
                                value: {
                                    accepted: true,
                                    username: result["username"],
                                    jsep: jsep,
                            ...
                            dispatch({
                                type: Constraint.EVENT_SIMULCAST,
                                value: {
                                    simulcast: true,
