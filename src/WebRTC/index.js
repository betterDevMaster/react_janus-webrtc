                        ...
                        success: function () {
                            ...
                            window.janus.attach({
                                ...
                                onlocalstream: function (stream) {
                                    ...
                                    window.Janus.attachMediaStream(
                                        $("#myvideo").get(0),
                                        stream
                                    )
                                ...
                                onremotestream: function (stream) {
                                    ...
                                    $("#bitrate a")
                                        ...
                                        .click(function () {
                                            ...
                                            if (bitrate === 0) {
                                                window.Janus.log(
                                                    "Not limiting bandwidth via REMB"
                                                )
                                            } else {
                                                window.Janus.log(
                                                    "Capping bandwidth to " +
                                                        bitrate +
                                                        " via REMB"
                                                )
                                            }
                                ...
                                oncleanup: function () {
                                    ...
                                    if (WebRTC.getInstance().bitrateTimer)
                                        clearInterval(
                                            WebRTC.getInstance().bitrateTimer
                                        )
                                    WebRTC.getInstance().bitrateTimer = null
                                    $("#waitingvideo").remove()
                                    $("#videos").hide()
